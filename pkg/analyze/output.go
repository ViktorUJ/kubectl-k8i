...
type WorkloadOutput struct {
	...
	CPUOvercommitPct float64 `json:"cpu_overcommit_pct" yaml:"cpu_overcommit_pct"`
	...
	MemOvercommitPct float64 `json:"mem_overcommit_pct" yaml:"mem_overcommit_pct"`
}
